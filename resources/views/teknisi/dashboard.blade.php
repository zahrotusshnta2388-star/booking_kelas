            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('ruangan.create') }}" class="btn btn-outline-primary">
                            <i class="bi bi-plus-circle"></i> Tambah Ruangan Baru
                        </a>
                        <a href="{{ route('booking.create') }}" class="btn btn-outline-success">
                            <i class="bi bi-calendar-plus"></i> Buat Booking Baru
                        </a>
                        <a href="{{ route('ruangan.index') }}" class="btn btn-outline-info">
                            <i class="bi bi-building"></i> Kelola Data Ruangan
                        </a>
                        <a href="{{ route('booking.index') }}" class="btn btn-outline-warning">
                            <i class="bi bi-calendar-week"></i> Kelola Data Booking
                        </a>
                    </div>
                </div>
            </div>
