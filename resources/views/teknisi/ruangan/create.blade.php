                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select @error('ruangan_id') is-invalid @enderror" 
                                   ...
                                   @foreach($ruangans as $ruangan)  <!-- BENAR: ADA "as" -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('keperluan') is-invalid @enderror" 
                                   ...
                                   value="{{ old('keperluan') }}" 
                                   placeholder="Contoh: Kuliah, Rapat, Praktikum, Seminar" 
                                   required>
                            @error('keperluan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Pilih status booking. Untuk publik otomatis "Menunggu Konfirmasi"</small>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkAvailability() {
        ...
        // Tampilkan loading
        showResult('<div class="spinner-border spinner-border-sm" role="status"></div> Memeriksa ketersediaan...', 'info');
        ...
        .then(data => {
            if (data.available) {
                ...
                showResult('❌ <strong>' + data.message + '</strong>. Silakan pilih waktu lain.', 'danger');
            }
        })
        .catch(error => {
